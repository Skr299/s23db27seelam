...
router.get('/', function (req, res) {
 res.render('index', { title: 'restaurants App', user : req.user });
});
router.get('/register', function(req, res) {
 res.render('register', { title: 'restaurants App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'restaurants App Login', user : req.user });
 });
